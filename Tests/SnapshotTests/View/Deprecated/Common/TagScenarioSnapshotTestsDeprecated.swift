//
//  TagScenarioSnapshotTestsDeprecatedDeprecated.swift
...
enum TagScenarioSnapshotTestsDeprecated: String, CaseIterable {
    case test1
    case test2
    case test3
    case test4
    ...
    func configuration(isSwiftUIComponent: Bool) -> [TagConfigurationSnapshotTestsDeprecated] {
        switch self {
        case .test1:
    ...
    ///  - mode: all
    ///  - size: default
    private func test1(isSwiftUIComponent: Bool) -> [TagConfigurationSnapshotTestsDeprecated] {
    ...
    ///  - mode: all
    ///  - size: default
    private func test2(isSwiftUIComponent: Bool) -> [TagConfigurationSnapshotTestsDeprecated] {
    ...
    ///  - mode: default
    ///  - size: default
    private func test3(isSwiftUIComponent: Bool) -> [TagConfigurationSnapshotTestsDeprecated] {
        let intents = TagIntent.allCases
    ...
    ///  - mode: default
    ///  - size: default
    private func test4(isSwiftUIComponent: Bool) -> [TagConfigurationSnapshotTestsDeprecated] {
    ...
    ///  - mode: default
    ///  - size:  all
    private func test5(isSwiftUIComponent: Bool) -> [TagConfigurationSnapshotTestsDeprecated] {
        return [
            .init(
                scenario: self,
                intent: .main,
